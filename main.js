...
var $author$project$Main$Model = F4(
	function (original_length, alternative_length, original_amount, alternative_amount) {
		return {alternative_amount: alternative_amount, alternative_length: alternative_length, original_amount: original_amount, original_length: original_length};
	});
var $author$project$Main$init = _Utils_Tuple2(
	A4($author$project$Main$Model, 0, 0, 0, 0),
	$elm$core$Platform$Cmd$none);
...
var $author$project$Main$ComputeAltAmount = {$: 'ComputeAltAmount'};
			...
			case 'OrigLength':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							original_length: A2($elm$core$Maybe$withDefault, 0, _float)
						}),
					$author$project$Main$send($author$project$Main$ComputeAltAmount));
			case 'AltLength':
				var _float = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							alternative_length: A2($elm$core$Maybe$withDefault, 0, _float)
						}),
					$author$project$Main$send($author$project$Main$ComputeAltAmount));
			case 'OrigAmount':
				var _float = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							original_amount: A2($elm$core$Maybe$withDefault, 0, _float)
						}),
					$author$project$Main$send($author$project$Main$ComputeAltAmount));
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{alternative_amount: (model.original_length * model.original_amount) / model.alternative_length}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Main$AltLength = function (a) {
	return {$: 'AltLength', a: a};
};
var $author$project$Main$OrigAmount = function (a) {
	return {$: 'OrigAmount', a: a};
};
var $author$project$Main$OrigLength = function (a) {
	return {$: 'OrigLength', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Garnet i oppskriften:')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('orig_length')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Lengde i meter')
									])),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										...
										$elm$core$String$fromFloat(model.original_length)),
										$elm$html$Html$Events$onInput(
										A2($elm$core$Basics$composeL, $author$project$Main$OrigLength, $elm$core$String$toFloat))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('orig_amount')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Antall nøster')
									])),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('number'),
										$elm$html$Html$Attributes$value(
										$elm$core$String$fromFloat(model.original_amount)),
										$elm$html$Html$Events$onInput(
										A2($elm$core$Basics$composeL, $author$project$Main$OrigAmount, $elm$core$String$toFloat))
									]),
								_List_Nil)
							]))
					])),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Garnet som skal byttes til:')
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('alt_length')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('number'),
										$elm$html$Html$Attributes$value(
										$elm$core$String$fromFloat(model.alternative_length)),
										$elm$html$Html$Events$onInput(
										A2($elm$core$Basics$composeL, $author$project$Main$AltLength, $elm$core$String$toFloat))
									]),
								_List_Nil)
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('alt_amount')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Beregnet forbruk')
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('outputnumber')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($myrho$elm_round$Round$round, 2, model.alternative_amount))
									]))
							]))
					]))
			]));
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"OrigLength":["Maybe.Maybe Basics.Float"],"AltLength":["Maybe.Maybe Basics.Float"],"OrigAmount":["Maybe.Maybe Basics.Float"],"ComputeAltAmount":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}}}}})}});}(this));